...
@interface HYCJHomeTwoViewController ()<UICollectionViewDataSource,UICollectionViewDelegate,SDCycleScrollViewDelegate>{
    UIView *navView;
...
@implementation HYCJHomeTwoViewController
...
- (void)loadLiveListData{
    ...
    NSDictionary *dic;
    dic = @{@"liveTypeId":self.liveTypeId,@"recommend":@(recommend),@"liveVip":@"0",@"keyword":@"",@"page":@(page),@"limit":@"10"};
    [SVProgressHUD show];
