...
- (void)viewDidLoad {
    ...
    leftButton.frame = CGRectMake(0, 8, 48, 31);
    [leftButton addTarget:self action:@selector(popRootVC) forControlEvents:UIControlEventTouchUpInside];
        UIImageView *backview = [[UIImageView alloc]initWithFrame:CGRectMake(0, 6, 13, 22)];    backview.image = [UIImage imageNamed:@"back"];
    [leftButton addSubview:backview];
    ...
    self.navigationItem.title = tzImagePickerVc.title;
    _doneButton = [UIButton buttonWithType:UIButtonTypeCustom];
    
    _doneButton.frame = CGRectMake(SCREEN_WIDTH-64, 3, 44, 44);
    ...
    _numberImageView.frame = CGRectMake(44, 7, 30, 30);
    ...
    UIView *tools = [[UIView alloc]initWithFrame:CGRectMake(0, 0, 74, 44)];
    [tools addSubview:_doneButton];
    [tools addSubview:_numberImageView];
    [tools addSubview:_numberLabel];

//    UIBarButtonItem *rightBarButtonItems = [[UIBarButtonItem alloc]initWithCustomView:tools];
