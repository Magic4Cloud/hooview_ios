...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView {
    ...
    //修改
//    if (self.indexDelegate && [self.indexDelegate respondsToSelector:@selector(scrollcurrentIndex:)]) {
//        [self.indexDelegate scrollcurrentIndex:_currentIndex];
//    }
...
- (void)scrollViewDidEndDecelerating:(UIScrollView *)scrollView {
    ...
    if (scrollView.contentOffset.x == _oldOffSetX) {
        ...
        if (self.indexDelegate && [self.indexDelegate respondsToSelector:@selector(scrollcurrentIndex:)]) {
            [self.indexDelegate scrollcurrentIndex:currentIndex];
        }
    }
