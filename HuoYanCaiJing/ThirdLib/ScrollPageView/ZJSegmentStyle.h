...
/** 滚动条的长度 */
@property (nonatomic,assign) CGFloat scrollVLineWidth;
/** 可以滚动标题时，每一段的长度 */
...
/** 平移的x距离*/
@property (assign,nonatomic) CGFloat xPlus;

/** 文字距离边的*/
@property (assign,nonatomic) CGFloat titleCoverMargin;

/** 根据文字计算滚动条的长度*/
@property (assign,nonatomic) BOOL autoScrollLineWidth;
@property (assign,nonatomic) BOOL autoCoverWidth;
/** 开始文字距离屏幕左边的距离*/
@property (assign,nonatomic) CGFloat titleCoverLeftMargin;
